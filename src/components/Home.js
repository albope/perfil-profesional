...
const Home = () => {
  return (
    <div className="profile">
      ...
      <a href="https://drive.google.com/file/d/1RAQksWmqyRpRcBdX6T6QqbAFSqKoloGe/view?usp=drive_link" className="cv-link" target="_blank" rel="noopener noreferrer">Download My CV</a>
